...
import { RefreshTokenService, User } from '@loopback/authentication-jwt';
import { BindingKey } from '@loopback/core';
import { ArUser } from '../models';
import { Credentials } from './ar-user.service';
...
export declare namespace ArUserServiceBindings {
  const USER_SERVICE: BindingKey<UserService<ArUser, Credentials>>;
