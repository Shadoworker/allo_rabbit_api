...
import { Credentials, RefreshtokenService, RefreshTokenService, User } from '@loopback/authentication-jwt';
...
export declare namespace UserServiceBindings {
  const USER_SERVICE: BindingKey<UserService<ArUser, ArUserCredentials>>;
